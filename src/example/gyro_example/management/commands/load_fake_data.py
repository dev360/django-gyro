...
from gyro_example.models import Tenant, Shop, Customer, Product, Order, OrderItem
...
class Command(BaseCommand):
    ...
    def create_products(self, shops):
        products = []
        product_types = [
            'T-Shirt', 'Jeans', 'Sneakers', 'Jacket', 'Hat', 'Backpack', 
            'Phone Case', 'Headphones', 'Laptop', 'Tablet', 'Book', 'Mug',
            'Sunglasses', 'Watch', 'Wallet', 'Belt', 'Socks', 'Gloves'
        ]
