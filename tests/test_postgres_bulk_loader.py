...
from django_gyro.importing import PostgresBulkLoader, ImportContext
...
class TestPostgresBulkLoader:
    ...
    def test_creates_staging_table_with_same_structure(self):
        ...
        mock_cursor.execute.assert_called_once_with(
            "CREATE TEMP TABLE import_staging_test_model "
            "(LIKE test_model INCLUDING ALL)"
        )
