...
class TestPostgresExportSQLGeneration(TestCase):
    ...
    def test_handles_complex_where_clauses(self):
        ...
        queryset = PgSqlModel2.objects.filter(
            active=True,
            age__gte=18,
...
class TestPostgresExportCSVGeneration(TestCase):
    ...
    def test_handles_null_values_correctly(self):
        ...
        mock_data = [
            ...
            {'name': 'Test2', 'optional_field': 'Value'}
        ]
...
class TestPostgresExportForeignKeyHandling(TestCase):
    ...
    def test_handles_null_foreign_keys(self):
        ...
        mock_data = [
            ...
            {'name': 'Product 2', 'category_id': None}
        ]
...
class TestPostgresExportProgressTracking(TestCase):
    ...
    def test_completion_notifications(self):
        ...
        with patch('django_gyro.exporters.PostgresExporter.execute_export') as mock_export:
            ...
            result = exporter.export_with_completion(
                PgProgressModel3.objects.all(),
                "test.csv",
